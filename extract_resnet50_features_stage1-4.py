...
def extract_split(split: str, data_dir: str, batch_size: int = 256, num_workers: int = 1):
    ...
    ds = datasets.CIFAR100(root=data_dir, train=train_flag, download=True, transform=tfm)
...
def main():
    ...
    for split in ["train", "test"]:
        out_path = os.path.join(data_dir, f"cifar100_r50_{split}.pt")
        ...
        for lname in ["layer1", "layer2", "layer3", "layer4", "layer4b0", "layer4b1", "layer4b2"]:
            ...
            out_path_l = os.path.join(data_dir, f"cifar100_r50_{lname}_{split}.pt")
