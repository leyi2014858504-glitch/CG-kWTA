...
MODE_PATTERNS = {
    "geo_r": "results_kfrac_geo_r_mae*.yaml",
    "geo_r_shuffled": "results_kfrac_geo_r_mae_shuffle*.yaml",
    "geo_r_l7": "results_kfrac_random_vitmae*.yaml",
    "kwta": "results_kfrac_kwta_mae*.yaml",
}
