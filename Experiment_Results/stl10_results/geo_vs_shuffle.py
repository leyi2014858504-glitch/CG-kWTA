...
RE_R50     = re.compile(r"r_stl10(\d+)\.ya?ml$", re.IGNORECASE)
...
def load_all(data_dir: str, metric: str, nonshuffle_glob: str, shuffle_glob: str, random_glob: str, bestof_glob):
    ...
    # ensure all three columns exist, otherwise dropna could remove an entire group
...
def main():
    ...
    # print match counts so a stale plot is not mistaken for fresh data
    print("[Matched files]")
