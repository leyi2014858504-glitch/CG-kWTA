...
- numpy, pyyaml, cma, networkx, minisom
- pandas, openpyxl

Install:

```bash
pip install torch torchvision timm numpy pyyaml cma networkx minisom pandas openpyxl
```
...
- `GEO_PTS_INIT`  
  Point initialization mode (`randproj`, `meanvar`, `pca`, `som`, `external`, ...).
