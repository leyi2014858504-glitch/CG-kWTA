...
MODE_PATTERNS = {
    "geo_r": "results_kfrac_geo_r_r50*.yaml",
    "geo_m": "results_kfrac_geo_m_r50*.yaml",
    "random": "results_kfrac_random_r50*.yaml",
    "kwta": "results_kfrac_kwta_r50*.yaml",
    "bestof_random": "results_kfrac_bestof_random_sd*.yaml",
}
